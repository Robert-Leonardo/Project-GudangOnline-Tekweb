<?php
// File: login.php (Bagian PHP di paling atas)
include 'config.php';
...
if (isset($_POST['login'])) {
    ...
    // 1. Ambil password yang di-hash berdasarkan kolom 'name' dari tabel 'usernames'
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $hashed_password)) {
            // Login berhasil
            $stmt->close();
            // TODO: Ganti ini dengan halaman tujuan yang benar, misalnya home.php
    ...
    <div class="container">
        ...
        <div class="form-box" id="register-form">
            <form action="login_register.php" method="post">
                ...
                <p>Allready have account? <a href="#" onclick="showForm('login-form')">back</a></p>
            </form>
        </div>
    </div>
